...
// This file is for functionality demo purposes. It's largely taken from
...
var availableFilters = [
    ...
    },
    {
        ...
        generate: function (updateCallback) {
            ...
            return {
                ...
                getFilter: function () {
                    /*eslint new-cap: 0*/
                    return OpenSeadragon.Filters.COLORMAP(
                        cmapUpdate(),
                        spinnerSlider.getValue()
                    );
                },
    ...
    },
    {
        name: 'Colorize',
        help:
            'The adjustment range (strength) is from 0 to 100.' +
    ...
    },
    {
        name: 'Exposure',
        help:
            'Range is -100 to 100. Values < 0 will decrease ' +
    ...
    },
    {
        name: 'Hue',
        help:
            'hue value is between 0 to 100 representing the ' +
            ...
            return {
                ...
                getFilter: function () {
                    return function (context, callback) {
                        ...
                        var originalPixels = context.getImageData(
                            0,
                            0,
                            context.canvas.width,
                            context.canvas.height
                        ...
                        for (var i = 1; i < context.canvas.height - 1; i += 1) {
                            ...
                            for (
                                var j = 1;
                                j < context.canvas.width - 1;
                                j += 1
                            ) {
                                Gy =
                                    originalPixels[
                                        idx - onePixelOffset + oneRowOffset
                                    ] +
